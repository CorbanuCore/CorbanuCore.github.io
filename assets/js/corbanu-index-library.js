(function () {
  ...
  function render() {
    ...
    for(const [i,row] of visible.entries()) {
      ...
      identity.append(ui.node("small",row.generation_origin==="user_generated"?"User generated · User-defined holdings":"AI generated · Creator-defined theme","generation-tag"));
