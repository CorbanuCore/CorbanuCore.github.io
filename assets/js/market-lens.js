(function () {
  ...
  function renderEarningsOptions(options) {
    ...
    if (note && history) note.textContent = "Payout equals expiration value divided by the total ask. Historical replay uses the same strikes, debit, and event horizon against Sharadar adjusted prices. Historical option prices are not reconstructed.";
  }
