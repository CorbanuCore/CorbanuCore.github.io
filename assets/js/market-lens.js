(function () {
  ...
  function setupMarketSearch(universe) {
    if (!window.CorbanuMarketSearch) return;
    window.CorbanuMarketSearch.wire(window.CorbanuMarketSearch.normalize(universe));
  }
